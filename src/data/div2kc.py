...
class DIV2KC(srdata.SRData):
    def __init__(self, args, name='DIV2KC', train=False, benchmark=False, corruption="GaussianBlur", lr_only=False):
        super(DIV2KC, self).__init__(
